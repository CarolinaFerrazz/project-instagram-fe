import { ButtonFollow, ContainerButtonsProfile, ContainerImageAndNumbers, ContainerInfoNumbers, ContainerNumberAndTitle, DescriptionProfile, ImageProfile, NameProfile, NumberInfoNumbers, TitleInfoNumbers, UserName } from "./styles";
...
export default function ViewProfileDiv(props) {
    ...
    return (
        <>
            ...
            <DescriptionProfile>{description ? description : "Say whats on your mind"}</DescriptionProfile>
